...
public sealed class ProjectDependencyGuardrailTests
{
    ...
    public void ProductionProjectReferences_KeepCurrentRuntimeOwnershipDirectionExplicit()
    {
        ...
        Assert.DoesNotContain("HapticDrive.Asio.Telemetry.F1_25", graph["HapticDrive.Asio.Runtime"]);
        ...
        Assert.DoesNotContain("HapticDrive.Asio.Runtime", graph["HapticDrive.Actuation"]);
