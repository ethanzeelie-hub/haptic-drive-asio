...
- Stages 23C through 23I have now extracted Dashboard, Devices, Effects, Routing / Mixer, Telemetry / UDP, Profiles, and Testing / Validation into dedicated view/presenter seams, but `MainWindow.xaml` and `MainWindow.xaml.cs` still remain the deliberate composition/runtime shell for page selection, cross-page direct WPF assignment outside extracted presentation slices, runtime snapshot gathering, startup/shutdown sequencing, and execution-heavy lifecycle/safety work.
