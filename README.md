...
Stage 13: Kerb, impact, road texture, and slip effects complete. Next stage is Stage 14, UI tuning, profiles, and diagnostics.
...
- `src/HapticDrive.Asio.Audio`: audio output abstractions, mixer, safety chain, test bench, and Stage 12 / Stage 13 effect generators.
