...
- The Telemetry / UDP recording library now adds on-demand selected-recording packet histograms for F1 25 captures in the app layer, so deeper packet-shape inspection is available without pushing game-specific analysis down into the generic recording assembly.
