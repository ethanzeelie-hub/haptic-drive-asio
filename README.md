...
- The Telemetry / UDP recording library now adds on-demand selected-recording packet histograms plus a first-pass packet preview for F1 25 captures in the app layer, and the selected detail can now be copied or exported as a sanitized local text artifact without pushing game-specific analysis down into the generic recording assembly.
