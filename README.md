...
Phase 3A: Production P-HPR output adapter hardening complete. Stage 18 remains the final Phase 1 pre-shaker readiness package.
...
- `src/HapticDrive.Simagic.PHPR.Output.Windows`: gated Windows HID P-HPR direct-output adapter, SimHub F1 EC report encoder, fakeable report writer lifecycle boundary, direct gear-pulse router, and Phase 3A connection/write diagnostics.
