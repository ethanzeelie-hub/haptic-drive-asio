...
Stage 2R: Controlled real P-HPR validation harness complete. Stage 18 remains the final Phase 1 pre-shaker readiness package.
...
- `src/HapticDrive.Simagic.PHPR.Output.Windows`: Stage 2Q gated Windows HID P-HPR direct-output adapter, SimHub F1 EC report encoder, fakeable report writer boundary, and direct gear-pulse router.
