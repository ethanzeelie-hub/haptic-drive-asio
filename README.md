...
Phase 3B: Instant paddle gear pulse production integration complete. Stage 18 remains the final Phase 1 pre-shaker readiness package.
...
- `src/HapticDrive.Simagic.PHPR.Output.Windows`: gated Windows HID P-HPR direct-output adapter, SimHub F1 EC report encoder, fakeable report writer lifecycle boundary, direct gear-pulse router, Phase 3A connection/write diagnostics, and Phase 3B instant-shift latency traces.
