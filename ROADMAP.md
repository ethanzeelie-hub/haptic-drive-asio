...
24. Phase 3F: Integrated replay validation. Next.

The extended Phase 2 / Phase 3 master prompt authorizes implementing the gated Stage 2Q code path, controlled validation harness, adapter hardening, instant gear-pulse route, road-vibration route, wheel-slip/wheel-lock route, and P-HPR UI/profile/diagnostics workflow. It does not authorize unattended hardware vibration, automated real writes, startup pulses, persisted arming, or physical validation claims.
