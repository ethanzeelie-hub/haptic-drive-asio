...
- Next production-hardening priority: final production-readiness acceptance tightening, MainWindow/code-surface reduction to final guardrails, coverage target uplift, and final blocker classification.
